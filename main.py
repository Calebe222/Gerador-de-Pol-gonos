...
class Navigation:
    def __init__(self, num_to_show, root, progress_bar):
        self.num_polygons = 0  
        self.num_sides = 0 
    ...
    def reset(self):
        for widget in self.root.winfo_children():
            widget.grid_remove()
        # Exibe o frame inicial novamente de forma limpa
...
def on_button_click():
    ...
    try:
        ...
        # CORREÇÃO AQUI: Passando 'num_to_show' primeiro, correspondendo ao __init__
        nav = Navigation(num_to_show, root, progress_bar)
        ...
        # Oculta o frame inicial de configuração para dar espaço aos gráficos
        frame.grid_remove()
